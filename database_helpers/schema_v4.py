# database_helpers/schema_v4.py


class SchemaSetup:
    """Database schema and migrations for version 4.0."""

    def _add_column_if_not_exists(self, table_name, column_name, column_type="TEXT", default_value="NULL"):
        try:
    ...
    def setup_database(self):
        print("--- Running SchemaSetup.setup_database() for 4.0 ---")
        ...
        for col, col_type, default in [
            ("is_research", "INTEGER", "0"),
            ("is_annotated_bib", "INTEGER", "0"),
            ("class_notes_html", "TEXT", "NULL"),
            ("synthesis_notes_html", "TEXT", "NULL"),
        ]:
            self._add_column_if_not_exists("items", col, col_type, default)
        ...
        CREATE TABLE IF NOT EXISTS user_settings (
            ...
            app_version TEXT DEFAULT '4.0',
            citation_style TEXT DEFAULT 'apa'
        )
        """)
        self._add_column_if_not_exists("user_settings", "app_version", "TEXT", "'4.0'")
        ...
        """)
        for col, col_type, default in [
            ("elevator_abstract_html", "TEXT", "NULL"),
            ("unity_kind_of_work", "TEXT", "NULL"),
            ("unity_driving_question_id", "INTEGER", "NULL"),
        ]:
            self._add_column_if_not_exists("readings", col, col_type, default)
        ...
        self.conn.commit()
        print("--- Schema setup complete for 4.0. ---")
