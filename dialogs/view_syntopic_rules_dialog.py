# dialogs/view_syntopic_rules_dialog.py
import sys
...
class ViewSyntopicRulesDialog(QDialog):
    """
    A simple dialog to display the (formatted) syntopic reading rules.
    Read-only.
    """

    def __init__(self, rules_html, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Syntopical Reading Rules")
