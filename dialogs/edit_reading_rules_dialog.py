# dialogs/edit_reading_rules_dialog.py
import sys
...
try:
    ...
    print("Error: Could not import RichTextEditorTab for EditReadingRulesDialog")
    RichTextEditorTab = None


class EditReadingRulesDialog(QDialog):
    """
    A dialog to edit the reading rules using the full
    RichTextEditorTab.
    """

    def __init__(self, rules_html, spell_checker_service=None, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Edit Analytical Reading Rules")
        ...
        if RichTextEditorTab:
            self.editor = RichTextEditorTab("Reading Rules Editor", spell_checker_service)
